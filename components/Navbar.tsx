...
export default function Navbar() {
  ...
  return (
    <nav className="h-20 border border-b-gray-20 w-full shadow-sm p-4 sm:px-10 flex justify-between align-center fixed top-0 bg-white">
      <div className="grow basis-0 hidden my-auto font-semibold text-lg sm:text-lg text-rose-500 cursor-pointer sm:flex sm:gap-2">
        <MdOutlineModeOfTravel className="text-4xl my-auto" />
        <div className="my-auto">Nextbnb</div>
      </div>

      <div className="w-full sm:w-[280px] border border-gray-200 rounded-full hover:shadow-lg cursor-pointer flex justify-between pl-6 pr-2">
      ...
      <div className="grow basis-0  hidden sm:flex gap-4 align-middle justify-end my-auto relative">
        <button
          type="button"
